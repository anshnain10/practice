...
//count of subsequence whose sum=k
    static int  PrintSubsSum2(int index, int[] arr, int n, int s, int sum) {
        ...
        if (index == n) {
            ...
            s += arr[index];
            int l=PrintSubsSum2(index + 1, arr, n, s, sum);

            s -= arr[index];

           int r=PrintSubsSum2(index + 1,  arr, n, s, sum);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(PrintSubsSum2(0, arr1, n1, 0, 3));
